#!/usr/bin/env python3
#
# click_n_fly3 = click_n_fly2 (same mature base) + deconfliction by
# LAMBDA SCHEDULING: instead of delaying whole trajectories at start,
# the safety check pauses lower-priority drones ON their path just
# before each conflict zone (spatial_deconfliction.py). Geometry is
# never touched. Testbed before merging the method into click_n_fly2.
#
