...
# file (<section name="BAT">) rather than hardcoded in the GUI: drones may
# carry different packs, and changing a threshold should not mean editing the
# code. This reuses the values the autopilot itself flies with, so the HMI and
# the aircraft agree on what "low" and "critical" mean.
#
#   <section name="BAT">
